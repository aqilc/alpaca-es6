...
export class Client extends EventEmitter {
   ...
   * @param {boolean} [param.ratelimit] - Whether the rate limit should be applied or not
   ...
   * @param {boolean} [param.autoconnect] - Whether or not you want to do a separate .connect() method for this client. `true` means that it should do it for you in the constructor.
   */
   ...
   */
  get info() { return this.request({ endpoint: 'account' }) }
